...
class Hd_model:
	...
	def test_hd(self,fold = 0):
		...
		LDApred = clf_LDA.predict(svm_train_feat,train_label)
		print("LDA Prediction: ", LDApred)

		# HD
		hd_b.fit(train_feat,train_label)
		HDBpred = hd_b.predict(train_feat,train_label)
		print("HD_B Prediction: ", HDBpred)
